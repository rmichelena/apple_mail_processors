(*
	Procesar Correos de Viajes de Taxi
	...
	- Extraer la información del viaje
	- Agregarlo al CSV consolidado
	- Marcar como leído y mover a la carpeta Taxis
*)
...
-- Archivo de log
property logFile : "~/Library/Logs/MailTaxiRule.log"
